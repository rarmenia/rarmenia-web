...
const Tile = (props: Props) => {
  ...
  const getTileColor = () => {
    ...
    const l = deg > dispayDeg ? Math.max(0, hsl.l - dif * 0.3) : hsl.l;
  ...
  return (
    <div
      className={`tile w-32 h-32 grid place-items-center rounded-sm ${textColor} text-lg font-bold`}
      style={{
