...
const WorkInformation = ({ work }: Props) => {
  ...
  const tabs = ['About', 'Positions', 'Projects'];
  ...
  return (
    <div className="p-2 flex flex-col items-center w-full gap-2">
      <Tab.Group>
        ...
        <Tab.Panels className="w-full grow bg-stone-950/60 rounded-md backdrop-blur-lg min-h-[20rem] max-h-[20rem] overflow-auto p-1">
