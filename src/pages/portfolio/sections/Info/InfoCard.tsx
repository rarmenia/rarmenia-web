...
const InfoCard = (props: Props) => {
  return (
    <div className={`flex flex-row gap-4 text-white items-center w-full ${props.isVisible ? 'animate-[fade-in_1300ms_ease-in_5ms_forwards]' : 'opacity-0'}`} title={props.title}>
