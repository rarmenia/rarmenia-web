...
import LoadCopy from "@components/data-display/LoadCopy";
...
const BusinessCardInfo = () => {
  ...
  return (<div className='flex flex-col items-center md:items-start md:justify-evenly p-2 md:mx-auto text-white transition-all gap-6 md:gap-2 mb-8 '>
    <NameSection />
    ...
    <FancyQuote className='text-xs/none font-d-sans p-4 border border-white/5 border-dashed rounded-sm flex flex-col gap-1 w-10/12'>
      <LoadCopy target='businessCard-about' />
    </FancyQuote>
  </div>)
